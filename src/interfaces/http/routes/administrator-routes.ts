import { authenticateAdministratorSchema } from '@application/administrator/validators/authenticate-administrator.schema'
import { createAdministratorSchema } from '@application/administrator/validators/create-administrator.schema'
import { fetchCompaniesSchema } from '@application/administrator/validators/fetch-companies.schema'
import { fetchPlansSchema } from '@application/administrator/validators/fetch-plans.schema'
import { getCompanySchema } from '@application/administrator/validators/get-company.schema'
import { registerCompanySchema } from '@application/administrator/validators/register-company.schema'
import { createPlanSchema } from '../../../application/administrator/validators/create-plan.schema'
